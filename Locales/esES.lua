...
L.OPTION_SORT_LABEL = "Ordenar misiones por tipo"
L.OPTION_SORT_TOOLTIP = "Ordena las misiones seguidas por tipo: Importante, Legendaria, Meta, Repetible, Trama y después todo lo demás."
L.OPTION_121_NOTE = "Nota para el parche 12.1: el rastreador de Blizzard sigue comprobando tus beneficios cada vez que se redibuja, algo heredado de Shadowlands. En 12.1 se bloquearon esos datos, así que en cuanto un accesorio toca el rastreador esa comprobación puede fallar y el rastreador deja de actualizarse hasta que uses /reload."
L.OPTION_NEEDS_RELOAD = "El cambio surte efecto tras un /reload."
L.MSG_OPT_IN_RESET = "ambas funciones están ahora desactivadas hasta que las actives: consulta las opciones del accesorio para ver qué implica cada una en el parche 12.1."
