...
L.MSG_DISABLED_121_TAINT = "desativado no patch 12.1: um erro da Blizzard congela todo o rastreador de missões quando um addon o modifica. Nada é modificado. O addon voltará a funcionar em um patch que corrija isso."
L.OPTION_SPLIT_OVERRIDE_121 = "Marcar isto faz o addon funcionar mesmo assim, após um /reload. O rastreador de missões deixará de atualizar até você recarregar novamente."
