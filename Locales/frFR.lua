...
L.OPTION_SORT_LABEL = "Trier les quêtes par type"
L.OPTION_SORT_TOOLTIP = "Trie les quêtes suivies par type : Important, Légendaire, Méta, Répétable, Fil narratif, puis tout le reste."
L.OPTION_121_NOTE = "Remarque pour le patch 12.1 : le suivi de quêtes de Blizzard vérifie encore vos buffs à chaque redessin, un reliquat de Shadowlands. En 12.1, les données de buff ont été verrouillées ; dès qu'un addon touche au suivi, cette vérification peut échouer et le suivi cesse de se mettre à jour jusqu'à un /reload."
L.OPTION_NEEDS_RELOAD = "La modification prend effet après un /reload."
L.MSG_OPT_IN_RESET = "les deux fonctions sont désormais désactivées jusqu'à ce que vous les activiez : voyez les options de l'addon pour ce que chacune implique sur le patch 12.1."
