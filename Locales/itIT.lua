...
L.MSG_DISABLED_121_TAINT = "disattivato nella patch 12.1: un bug di Blizzard blocca l'intero tracciatore delle missioni quando un addon lo modifica. Non viene modificato nulla. L'addon tornerà a funzionare con una patch che risolva il problema."
L.OPTION_SPLIT_OVERRIDE_121 = "Selezionando questa opzione l'addon verrà comunque eseguito, dopo un /reload. Il tracciatore delle missioni smetterà allora di aggiornarsi fino al ricaricamento successivo."
