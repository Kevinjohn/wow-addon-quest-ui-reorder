...
L.MSG_DISABLED_121_TAINT = "auf Patch 12.1 deaktiviert: Ein Fehler von Blizzard friert die gesamte Questverfolgung ein, sobald ein Addon sie verändert. Es wird nichts verändert. Das Addon funktioniert wieder, sobald ein Patch den Fehler behebt."
L.OPTION_SPLIT_OVERRIDE_121 = "Wenn du dies aktivierst, läuft das Addon nach einem /reload trotzdem. Die Questverfolgung aktualisiert sich dann nicht mehr, bis du erneut neu lädst."
