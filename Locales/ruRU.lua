...
L.MSG_DISABLED_121_TAINT = "отключён в патче 12.1: из-за ошибки Blizzard всё отслеживание заданий зависает, если аддон его изменяет. Ничего не изменяется. Аддон снова заработает в патче, где ошибку исправят."
L.OPTION_SPLIT_OVERRIDE_121 = "Если включить это, аддон всё равно заработает после /reload. Отслеживание заданий тогда перестанет обновляться до следующей перезагрузки интерфейса."
