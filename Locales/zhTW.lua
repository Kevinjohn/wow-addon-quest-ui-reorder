...
L.OPTION_SORT_LABEL = "依類型排序任務"
L.OPTION_SORT_TOOLTIP = "將追蹤的任務依類型排序：重要、傳說、主任務、可重複、故事線，然後是其餘任務。"
L.OPTION_121_NOTE = "12.1 版本提示：暴雪的任務追蹤器仍保留著暗影之境時期的程式碼，每次重繪都會檢查你的增益效果。12.1 鎖定了增益資料，因此只要插件改動追蹤器，該檢查就可能失敗，追蹤器會停止更新，直到你執行 /reload。"
L.OPTION_NEEDS_RELOAD = "此項變更需要 /reload 後才會生效。"
L.MSG_OPT_IN_RESET = "兩項功能現在都是關閉的，需要你手動開啟：請在插件選項中查看它們在 12.1 版本的影響。"
